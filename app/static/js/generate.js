window.onload = function(event){
    ...
    genbtn.addEventListener('click', (event) => {
        ...
        .then(data => {
            ...
            if(response == 'NOK'){
                error.innerHTML = `<div class="alert alert-danger">Weekly Meal Plan has already been generated</div>`;
            }else if(response == 'OK'){
                if(sanitized == true && value == ""){
                    ...
                    error.innerHTML = `<div class="alert alert-danger">You have Invalid Input</div>`;
                }
